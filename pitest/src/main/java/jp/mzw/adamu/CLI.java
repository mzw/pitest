...
public class CLI {
	public static void main(String[] args)
			throws IOException, SQLException, ClassNotFoundException, InstantiationException, IllegalAccessException, MavenInvocationException {
		if (args.length == 0) {
		...
		InputStream is = CLI.class.getClassLoader().getResourceAsStream("logging.properties");
		if (is != null) {
