...
public class CoxRegression extends Regression
{
    ...
    public double[] initialEstimate = null;
    ...
    public int maxIterationNumber = 1000;
                                  ...
                                  double[] ...covariate)
    {
        ...
        BasicStatistics.maxIterationNumber = maxIterationNumber;
        BasicStatistics.initialEstimate = initialEstimate;
        if(BasicStatistics.initialEstimate == null)
        {
            BasicStatistics.initialEstimate = new double[covariate.length];
            for(int i = 0; i < covariate.length; i++)
            {
                    BasicStatistics.initialEstimate[i] = 0.1;
            }
        }
        coefficientMatrix = new Matrix(BasicStatistics.initialEstimate,
                                       covariate.length);
        ...
        while ((error1 > BasicStatistics.convergenceCriterion[0]) ||
               (error2 > BasicStatistics.convergenceCriterion[0]) ||
                iterationIndex < BasicStatistics.maxIterationNumber)
        {
